...
#define e101 "Llamada a key() con un c\xa2digo de tecla inexistente."
#define e102 "No se pudo cargar la paleta, archivo no encontrado."
#define e103 "Se intent\xa2 cargar un archivo de paleta inv\xa0lido."
#define e104 "Demasiados ficheros FPG abiertos a la vez."
#define e105 "No se pudo cargar el fichero, archivo no encontrado."
#define e106 "Se intent\xa2 cargar un fichero FPG no v\xa0lido."
#define e107 "N\xa3mero de scroll inv\xa0lido (debe estar entre 0 y 9)."
#define e108 "N\xa3mero de regi\xa2n inv\xa0lido (fuera de rango)."
#define e109 "C\xa2digo de fichero inv\xa0lido."
#define e110 "C\xa2digo de gr\xa0fico inv\xa0lido."
#define e111 "Se intent\xa2 usar un fichero FPG antes de cargarlo."
#define e112 "Se necesita un c\xa2digo de gr\xa0fico para el scroll."
#define e113 "Se han cargado demasiados fuentes de letras."
#define e114 "No se pudo cargar el fuente, archivo no encontrado."
#define e115 "Se intent\xa2 cargar un archivo de fuente no v\xa0lido."
#define e116 "C\xa2digo identificador de fuente de letras inv\xa0lido."
#define e117 "C\xa2digo de centrado de texto inv\xa0lido."
#define e118 "Hay demasiados textos activos en el programa."
#define e119 "Indentificador de texto no v\xa0lido."
#define e120 "Regi\xa2n de pantalla definida incorrectamente."
#define e121 "Se intent\xa2 utilizar un gr\xa0fico que no existe."
#define e122 "Se intent\xa2 escribir un bloque fuera de la memoria."
#define e123 "No se pudo abrir el archivo para escritura."
#define e124 "No se pudo escribir el archivo, \xa8se llen\xa2 el disco?."
#define e125 "Se intent\xa2 leer fuera de la memoria."
...
#define e130 "No se pudo iniciar la animaci\xa2n solicitada."
#define e131 "N\xa3mero de modo 7 inv\xa0lido (debe estar entre 0 y 9)."
#define e132 "Se necesita un c\xa2digo de gr\xa0fico para el modo 7."
#define e133 "N\xa3mero de punto de control inv\xa0lido."
#define e134 "N\xa3mero de bot\xa2n incorrecto (debe estar entre 0 y 3)."
#define e135 "N\xa3mero de eje incorrecto (debe estar entre 0 y 3)."
#define e136 "Direcci\xa2n de la tabla de paleta fuera de la memoria."
#define e137 "No se pueden comprobar regiones en gr\xa0ficos de m-7."
#define e138 "C\xa2digo de informaci\xa2n gr\xa0fica incorrecto."
#define e139 "No se pueden comprobar colisiones en gr\xa0ficos de m-7."
#define e140 "Acceso fuera de rango."
#define e141 "Se intent\xa2 acceder a un proceso inv\xa0lido."
#define e142 "El proceso parece bloqueado, esperando FRAME."
#define e143 "No se pudo cargar el mapa, archivo no encontrado."
#define e144 "Se intent\xa2 cargar un archivo de mapa inv\xa0lido."
#define e145 "Se ha intentado hacer una divisi\xa2n entre cero."
#define e146 "El tama\xa4o de la regi\xa2n es incorrecto."
#define e147 "No se pudo cargar FLI/FLC, archivo no encontrado."
#define e148 "Valor de timeout incorrecto (debe ser entre 1 y 60)."
#define e149 "N\xa3mero de jugadores incorrecto (debe ser entre 2 y 8)."
#define e150 "S\xa2lo se pueden enviar datos globales."
#define e151 "Tama\xa4o de casilla inv\xa0lido (debe ser entre 1 y 256)."
#define e152 "Mapa de b\xa3squeda no v\xa0lido (desde 1x1 hasta 128x128)."
#define e153 "Tama\xa4o de mapa incorrecto (de 1x1 a 32768x32768)."
#define e154 "N\xa3mero de color incorrecto (debe ser de 0 a 255)."
#define e155 "El centro est\xa0 fuera de los l\xa1mites del gr\xa0fico."
/*
