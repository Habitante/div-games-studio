...
void Tap_Setup1(void) {
  ...
  for (x = 0; x < 32; x++)
    wbox(v.ptr, an, al, wallpaper_gradient[x * 4], an - 37 + x, 24 + 9, 1, 5);
}
...
void cfg_show_cursor(void) {
  ...
  if (big) {
    switch (paint_cursor) {
    case 0:
      wput(v.ptr, v.an, v.al, (92 + 3 + 30) * 2, (69 + 3 + 30) * 2, 19);
      break;
    case 1:
      wput(v.ptr, v.an, v.al, (92 + 2 + 30) * 2, (69 + 2 + 30) * 2, 22);
      break;
    case 2:
      wput(v.ptr, v.an, v.al, (92 + 2 + 30) * 2, (69 + 2 + 30) * 2, 26);
      break;
    }
  } else {
    switch (paint_cursor) {
    case 0:
      wput(v.ptr, v.an, v.al, 92 + 3 + 30, 69 + 3 + 30, 20);
      break;
    case 1:
      wput(v.ptr, v.an, v.al, 92 + 2 + 30, 69 + 2 + 30, 23);
      break;
    case 2:
      wput(v.ptr, v.an, v.al, 92 + 2 + 30, 69 + 2 + 30, 27);
      break;
    }
  }
}
...
void cfg_show_font(void) {
  ...
  switch (editor_font) {
  case 0:
    wwrite(v.ptr, an, al, 101 + 18 + 50, 56 + 30, 1, (byte *)"6x8", c3);
    break;
  case 1:
    wwrite(v.ptr, an, al, 101 + 18 + 50, 56 + 30, 1, (byte *)"8x8", c3);
    break;
  case 2:
    wwrite(v.ptr, an, al, 101 + 18 + 50, 56 + 30, 1, (byte *)"8x11", c3);
    break;
  case 3:
    wwrite(v.ptr, an, al, 101 + 18 + 50, 56 + 30, 1, (byte *)"9x16", c3);
    break;
  }
...
void Cfg_Setup2(void) {
  ...
  if (zona == 13 && (mouse_b & 1) && wmouse_x != -1) {
    if (!(v.buttons & 1)) {
      wput(v.ptr, an, al, 53 + 50, 56 + 30, -53);
      v.buttons ^= 1;
      v.redraw = 1;
    }
  } else if (v.buttons & 1) {
  ...
  if (zona == 14 && (mouse_b & 1) && wmouse_x != -1) {
    if (!(v.buttons & 2)) {
      wput(v.ptr, an, al, 93 + 50, 56 + 30, -54);
      v.buttons ^= 2;
      v.redraw = 1;
    }
  } else if (v.buttons & 2) {
  ...
  if (zona == 16 && (mouse_b & 1) && wmouse_x != -1) {
    if (!(v.buttons & 4)) {
      wput(v.ptr, an, al, 53 + 50, 56 + 30 + inc, -53);
      v.buttons ^= 4;
      v.redraw = 1;
    }
  } else if (v.buttons & 4) {
  ...
  if (zona == 17 && (mouse_b & 1) && wmouse_x != -1) {
    if (!(v.buttons & 8)) {
      wput(v.ptr, an, al, 93 + 50, 56 + 30 + inc, -54);
      v.buttons ^= 8;
      v.redraw = 1;
    }
  } else if (v.buttons & 8) {
