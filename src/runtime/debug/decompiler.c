...
#define SAFE_SPRINTF(dst, fmt, ...) do { char _tmp_buf[512]; div_snprintf(_tmp_buf,sizeof(_tmp_buf),fmt,__VA_ARGS__); div_strcpy(dst,sizeof(dst),_tmp_buf); } while(0)
// Copy between different elements of the same array (compiler can't prove non-overlap)
static inline void array_strcpy(char *dst, size_t dst_size, const char *src) { char tmp[512]; div_strcpy(tmp,sizeof(tmp),src); div_strcpy(dst,dst_size,tmp); }
...
i=mem[1]-1;
    ...
    case ligu: 
		...
		div_snprintf(condstack[con],sizeof(condstack[con]),"%s == %s",cstack[sp-2],cstack[sp-1]);
    ...
    case lfun: 
		...
		switch(mem[i+1]) {
			...
			case 4: // start_scroll (6)
				div_snprintf(cmd,sizeof(cmd),"start_scroll(%s, %s, %s, %s, %s, %s)",cstack[sp-6],cstack[sp-5],cstack[sp-4],cstack[sp-3],cstack[sp-2],cstack[sp-1]);
				sp-=5;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
			...
			case 16: // write (5)
				div_snprintf(cmd,sizeof(cmd),"write(%d,%d,%d,%d,\"%s\")",stack[sp-5],stack[sp-4],stack[sp-3],stack[sp-2],(byte*)&mem[mem[7]+stack[sp-1]]);
				sp-=4;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;

			case 17:
				div_snprintf(cmd,sizeof(cmd),"write_int(%d,%d,%d,%d,&var%d)",stack[sp-5],stack[sp-4],stack[sp-3],stack[sp-2],stack[sp-1]);
				sp-=4;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
			...
			case 22: // define region (5)
				div_snprintf(cmd,sizeof(cmd),"define_region(%d,%d,%d,%d,%d)",stack[sp-5],stack[sp-4],stack[sp-3],stack[sp-2],stack[sp-1]);
				sp-=4;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
				
			case 24: // put (4)
				div_snprintf(cmd,sizeof(cmd),"put(%d,%d,%d,%d)",stack[sp-4],stack[sp-3],stack[sp-2],stack[sp-1]);
				sp-=3;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
			...
			case 27: // map_put(); 5
				div_snprintf(cmd,sizeof(cmd),"map_put(%s,%s,%s,%s,%s)",cstack[sp-5],cstack[sp-4],cstack[sp-3],cstack[sp-2],cstack[sp-1]);
				sp-=4;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
			...
			case 35: //load
				div_snprintf(cmd,sizeof(cmd),"load(\"%s\",offset var%d)",(byte*)&mem[mem[7]+stack[sp-2]],stack[sp-1]);
				sp--;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
			...
			case 37: // load_pcm (2)
				div_snprintf(cmd,sizeof(cmd),"load_pcm(\"%s\",%d)",(byte*)&mem[mem[7]+stack[sp-2]],stack[sp-1]);
				sp--;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
				
			case 39: // sound (3)
				div_snprintf(cmd,sizeof(cmd),"sound(%s,%s,%s)",getvarref(sp-3),getvarref(sp-2),getvarref(sp-1));
				sp-=2;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
			...
			case 54: // start_mode7 (6)
				div_snprintf(cmd,sizeof(cmd),"start_mode7(%s,%s,%s,%s,%s,%s)",cstack[sp-6],cstack[sp-5],cstack[sp-4],cstack[sp-3],cstack[sp-2],cstack[sp-1]);
				sp-=5;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
			...
			case 67: // exit (2)
				div_snprintf(cmd,sizeof(cmd),"exit(\"%s\",%d)",(byte*)&mem[mem[7]+stack[sp-2]],stack[sp-1]);
				sp--;
				div_strcpy(cstack[sp-1],sizeof(cstack[sp-1]),cmd);
				break;
